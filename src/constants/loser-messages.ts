export const LOSER_MESSAGES: string[] = [
  "Descends chercher la graille, sale bâtard avant que le livreur utilise ton tacos pour lustrer son ball-trap sur le parking",
  "Allez sale tocard descends avant que le livreur en ait marre et transforme ton sandwich en chiffon pour essuyer son ball-trap",
  "Descends sale bâtard avant que le livreur reparte avec ta graille qu'il se frotte le ball-trap avec ton sandwich et te laisse comment un connard avec ta vieille gueule",
